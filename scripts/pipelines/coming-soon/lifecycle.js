...
/**
 * Coming Soon Step 6: Lifecycle — check if coming_soon venues have opened.
 * Uses LLM to verify; if opened=true, transitions to recently_opened.
...
const { log, warn, close: closeLog } = createLogger('cs-lifecycle');
...
async function main() {
  ...
  log('=== Coming Soon Lifecycle Check ===');
  db.setAuditContext('pipeline', 'cs-lifecycle');
