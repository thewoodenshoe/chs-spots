...
export default function SubmissionModal({
  ...
  const [selectedType, setSelectedType] = useState<SpotType>('Happy Hour');
        ...
        <div className="flex flex-col h-full overflow-hidden">
          ...
          <div className="flex-shrink-0 px-6 pb-4 border-b border-gray-200">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-xl font-bold text-gray-800">Add New Spot</h2>
              <button
                type="button"
                onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto px-6 py-4">
            ...
            <div className="mb-4">
              ...
              <select
                value={selectedType}
                onChange={(e) => setSelectedType(e.target.value as SpotType)}
